...
**Important note**: As this is a 3D solver, the memory uasge and computation time scale as `N^3`. Beware of the memory usage aspecially when you are using the GPU.
